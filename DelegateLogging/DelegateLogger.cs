...
#pragma warning restore CA1822 // Mark members as static
        ...
        private DelegateLoggerScope<TState> GetScope<TState>() => (DelegateLoggerScope<TState>)_currentScopes.GetOrAdd(typeof(TState), (t) => new DelegateLoggerScope<TState>(_action, this));
        #endregion
    }
}
